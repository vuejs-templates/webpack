...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      ...
      {
        from: path.resolve(__dirname, '../libs/hybrid_app.js'),
