...
describe('HelloWorld.vue', () => {
  it('should render correct contents', () => {
    ...
    {{#if_eq runner "karma"}}.to.equal('Welcome to Your Vue.js App'){{#if_eq eslintConfig "airbnb"}};{{/if_eq}}{{/if_eq}}{{#if_eq runner "jest"}}.toEqual('Welcome to Your Vue.js App'){{#if_eq eslintConfig "airbnb"}};{{/if_eq}}{{/if_eq}}
